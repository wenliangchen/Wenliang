...
const data = [
  {
    ...
    desc:
      ...
      + 'Implement frontend with React.js and Bootstrap to provide access to configure and lunch student portal and generate the interactive visual reports'
      + 'Implemented and optimized Database query algorithms that reduced 37% of CPU Usage.'
      + 'Integrated with Spring Security to provide customize authentication and access-control',
  },
  {
    ...
    desc:
      ...
      + 'Integrated Celery and RabbitMQ message in backend jobs distribute for high concurrency and performance.'
  ...
  },
  {
    ...
    desc:
      ...
      + 'Designed a field goal filter for a detailed visualization of areas with different quarters. '
      + 'Created match filters to provide specific visual report for 7 different categories.'
      + 'Built the Server-less backend with AWS DynamoDB and GraphQL API to provide data accessing through AWS lambda for frontend interface',
  },
